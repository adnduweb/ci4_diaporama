...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<input type="hidden" name="module" value="<?= base64_encode('Adnduweb\Ci4_diaporama'); ?>" />
	<input type="hidden" name="controller" value="AdminDiaporamasController" />
								...
								<div class="kt-form__body">
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											<?= $this->include('\Adnduweb\Ci4_diaporama\Views\admin\themes\metronic\__form_section\general') ?>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="tab-pane" id="kt_user_edit_tab_2" role="tabpanel">
							<div class="kt-form kt-form--label-right">
								<div class="kt-form__body">
									<div class="kt-section kt-section--first">
										<div class="kt-section__body">
											<?= $this->include('\Adnduweb\Ci4_diaporama\Views\admin\themes\metronic\__form_section\diaporama') ?>
										</div>
									</div>
								</div>
							</div>
