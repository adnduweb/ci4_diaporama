...
<div class="content  d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div id="ContentDiaporama" class="d-flex flex-column-fluid">
            ...
            <div class="flex-row ">
                <div class="card card-custom gutter-b">
                    ...
                    <div class="card-body px-0">
                        <!--begin: Datatable -->
                        <div class="datatable datatable-bordered datatable-head-custom" id="kt_apps_diaporamas_list_datatable"></div>
                    </div>
                    <!--end: Datatable -->
                </div>
            </div>
