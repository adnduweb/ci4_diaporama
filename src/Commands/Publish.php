...
namespace Adnduweb\Ci4_diaporama\Commands;
...
class Publish extends BaseCommand
{
     ...
     * @var string
     */
    protected $name = 'Ci4_diaporama:publish';
     ...
     * @var string
     */
    protected $usage = 'Ci4_diaporama:publish';
    ...
    protected function publishModules()
    {
        ...
        $this->copydir($this->sourcePath, APPPATH . '/Modules/Ci4_diaporama');
